        ...
        <Table className="teacherTable" hover >
            <thead className="teacherHeadRow">
                <tr className="tableHead">
                    ...
                    <th className="darkGrayText" onClick={props.sortByName}>Name</th>
                    <th className="darkGrayText" onClick={props.sortByGrade}>Grade</th>
                    <th className="darkGrayText" onClick={props.sortByPrice}>Price/Week</th>
                    <th className="darkGrayText" onClick={props.sortByPod}>Pods</th>
